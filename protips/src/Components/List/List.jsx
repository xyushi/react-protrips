    ...
    render(){
        return(<div className="contain">
            ...
            <div className="details">
              ...
              <div>Filter By : </div>
              <input type="radio" onClick={this.click} value="All"></input>All
              <input type="radio" onClick={this.click} value="Trek" ></input>Trek
              <input type="radio" onClick={this.click} value="Club"></input>Club
              <input type="radio" onClick={this.click} value="Tropic"></input>Tropic
              </div>
        </div>)
    }
}
